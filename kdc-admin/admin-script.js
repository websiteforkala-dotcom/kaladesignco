        ...
        grid.innerHTML = this.workProjects.map(project => `
            <div class="work-card">
                <div class="work-image">
                    <img src="${(project.image_url && project.image_url.startsWith('./')) ? '.' + project.image_url : (project.image_url || '../assets/placeholder.jpg')}" alt="${project.title}" loading="lazy" onerror="this.src='../assets/placeholder.jpg'">
                </div>
                <div class="work-info">
                    <h4>${project.title}</h4>
